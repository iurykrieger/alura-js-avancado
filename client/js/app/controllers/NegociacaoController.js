...
System.register(['../models/NegociacaoList', '../models/Negociacao', '../models/Mensagem', '../views/NegociacoesView', '../views/MensagemView', '../services/NegociacaoService', '../helpers/DateHelper', '../helpers/Bind'], function (_export, _context) {
	"use strict";

	var NegociacaoList, Negociacao, Mensagem, NegociacoesView, MensagemView, NegociacaoService, DateHelper, Bind, _createClass, NegociacaoController, negociacaoController;
	...
	return {
		setters: [function (_modelsNegociacaoList) {
